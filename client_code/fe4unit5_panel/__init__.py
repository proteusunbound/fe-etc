...
class fe4unit5_panel(fe4unit5_panelTemplate):
  ...
  def setinfo(self):
    ...
    self.parent.combat.duels[4].setcanceladeptno(int(self.canceladept_drop.selected_value))
  ...
  def support_click(self, **event_args):
    ...
    if self.parent.combat.duels[4].unit.name not in ("Naoise", "Alec", "Arden", "Azelle", "Lex", "Quan", "Finn", "Midir", "Dew", "Ayra", "Deirdre", "Jamke", "Chulainn", "Lachesis", "Beowolf", "Lewyn", "Silvia", "Erinys", "Tailtiu", "Claud", "Seliph", "Oifey", "Julia", "Iucharba", "Iuchar", "Shannan", "Ares", "Hannibal"):
