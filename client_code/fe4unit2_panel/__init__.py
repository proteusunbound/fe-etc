...
class fe4unit2_panel(fe4unit2_panelTemplate):
  ...
  def setinfo(self):
    ...
    self.parent.combat.duels[1].setpaviseno(int(self.pavise_drop.selected_value))
  ...
  def skills_click(self, **event_args):
    ...
    if "Pavise" in self.parent.combat.duels[1].unit.skills:
  ...
  def refreshbox_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].refresh = self.refreshbox.checked

  def father_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.setfather(self.father_drop.selected_value)
    self.hp.text = self.parent.combat.duels[1].unit.maxhp
    self.strength.text = self.parent.combat.duels[1].unit.strength
    self.magic.text = self.parent.combat.duels[1].unit.magic
    self.skill.text = self.parent.combat.duels[1].unit.skill
