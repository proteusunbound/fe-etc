...
from ._anvil_designer import fe5unit4_panelTemplate
from anvil import *
...
class fe5unit4_panel(fe5unit4_panelTemplate):
  """Unit Template"""
  ...
  def unit_drop_change(self, **event_args):
    ...
    self.build.text = self.parent.combat.duels[3].unit.build
  ...
  def setinfo(self):
    ...
    self.parent.combat.duels[3].setmiracleno(int(self.miracle_drop.selected_value))
  ...
  def starsbox_pressed_enter(self, **event_args):
    ...
    self.parent.combat.duels[3].unit.leaderstars = self.starsbox.text
    self.parent.combat.duels[3].unitdisplay()
    self.hit.text = self.parent.combat.duels[3].unit.hit
  ...
  def skills_click(self, **event_args):
    ...
    if "Miracle" in self.parent.combat.duels[3].unit.skills:
