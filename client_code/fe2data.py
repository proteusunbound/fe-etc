...
class DuelSim:
    ...
    def damageadjust(self):
        """Adjust Damage"""
        if self.unit.charclass == "Falcon Knight" and self.boss.charclass in (
            "Bonewalker",
            "Revenant",
            "Necrodragon",
            "Gargoyle",
    ...
    def unitstatadjust(self):
        ...
        if self.unitequip == "Silver Shield":
            self.unit.defense += 7
        if self.unitequip == "Blessed Shield" and self.boss.charclass in (
            "Bonewalker",
            "Revenant",
            "Necrodragon",
            "Gargoyle",
