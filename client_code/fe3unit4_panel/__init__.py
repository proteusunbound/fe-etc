"""Unit 4 Panel"""
from ._anvil_designer import fe3unit4_panelTemplate
from anvil import *
...
class fe3unit4_panel(fe3unit4_panelTemplate):
  """Unit Template"""
  ...
  def unit_drop_change(self, **event_args):
    ...
    self.parent.combat.duels[3].unit.setsupports()
    ...
    if self.parent.combat.duels[3].unit.name not in (
        "Jagen",
        "Bord",
        "Cord",
        "Barst",
    ...
    if self.parent.combat.duels[3].unit.charclass in ("Cavalier", "Paladin", "Horseman", "Pegasus Knight", "Dracoknight"):
      self.dismountbox.visible = True
    if self.parent.combat.duels[3].unit.charclass in ("Cavalier", "Armor Knight", "Archer", "Hunter", "Mercenary", "Mage", "Cleric", "Pegasus Knight"):
  ...
  def support1_change(self, **event_args):
    ...
    self.parent.combat.duels[3].unit.setsupportbonus(
  ...
  def dismountbox_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].unit.dismount()
    self.strength.text = self.parent.combat.duels[3].unit.strength
    self.skill.text = self.parent.combat.duels[3].unit.skill
    self.speed.text = self.parent.combat.duels[3].unit.speed
    self.defense.text = self.parent.combat.duels[3].unit.defense
  ...
  def promobox_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].unit.promote()
    self.hp.text = self.parent.combat.duels[3].unit.maxhp
    self.strength.text = self.parent.combat.duels[3].unit.strength
    self.skill.text = self.parent.combat.duels[3].unit.skill
    self.speed.text = self.parent.combat.duels[3].unit.speed
  ...
  def powerdrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].unit.boost_strength(
  ...
  def secretdrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].unit.boost_skill(
  ...
  def speedring_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].unit.boost_speed(
  ...
  def dracoshield_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].unit.boostdefense(
  ...
  def talismandrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].unit.boostresistance(
  ...
  def geosphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].setequipment("Geosphere")
    self.parent.combat.duels[3].unitdisplay()
    self.hit.text = self.parent.combat.duels[3].unit.hit
    self.crit.text = self.parent.combat.duels[3].unit.crit
  ...
  def lightsphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].setequipment("Lightsphere")
    for number, name in self.parent.combat.duels.items():
      name.bossdisplay()
    self.parent.crit.text = self.parent.combat.duels[3].boss.crit

  def lifesphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].setequipment("Lifesphere")

  def iote_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[3].setequipment("Iote's Shield")
  ...
  def dancedrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[3].setrefreshes(int(self.dancedrop.selected_value))
