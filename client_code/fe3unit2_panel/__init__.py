...
class fe3unit2_panel(fe3unit2_panelTemplate):
  ...
  def unit_drop_change(self, **event_args):
    ...
    if self.parent.combat.duels[1].unit.name in (
        "Astram",
        "Abel",
        "Est",
        "Ogma",
    ...
    if self.parent.combat.duels[1].unit.charclass in ("Cavalier", "Paladin", "Horseman", "Pegasus Knight", "Dracoknight"):
      self.dismountbox.visible = True
    if self.parent.combat.duels[1].unit.charclass in ("Cavalier", "Armor Knight", "Archer", "Hunter", "Mercenary", "Mage", "Cleric", "Pegasus Knight"):
  ...
  def support1_change(self, **event_args):
    ...
    self.parent.combat.duels[1].unit.setsupportbonus(
  ...
  def book2box_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].unit.booktwo(self.book2box.checked)
    self.hp.text = self.parent.combat.duels[1].unit.maxhp
    self.strength.text = self.parent.combat.duels[1].unit.strength
    self.skill.text = self.parent.combat.duels[1].unit.skill
    self.speed.text = self.parent.combat.duels[1].unit.speed
  ...
  def dismountbox_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].unit.dismount()
    self.strength.text = self.parent.combat.duels[1].unit.strength
    self.skill.text = self.parent.combat.duels[1].unit.skill
    self.speed.text = self.parent.combat.duels[1].unit.speed
    self.defense.text = self.parent.combat.duels[1].unit.defense
  ...
  def powerdrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.boost_strength(
  ...
  def secretdrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.boost_skill(
  ...
  def speedring_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.boost_speed(
  ...
  def dracoshield_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.boostdefense(
  ...
  def talismandrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].unit.boostresistance(
  ...
  def geosphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].setequipment("Geosphere")
    self.parent.combat.duels[1].unitdisplay()
    self.hit.text = self.parent.combat.duels[1].unit.hit
    self.crit.text = self.parent.combat.duels[1].unit.crit
  ...
  def lightsphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].setequipment("Lightsphere")
    for number, name in self.parent.combat.duels.items():
      name.bossdisplay()
    self.parent.crit.text = self.parent.combat.duels[1].boss.crit

  def lifesphere_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].setequipment("Lifesphere")

  def iote_change(self, **event_args):
    """This method is called when this checkbox is checked or unchecked"""
    self.parent.combat.duels[1].setequipment("Iote's Shield")
  ...
  def dancedrop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].setrefreshes(int(self.dancedrop.selected_value))
