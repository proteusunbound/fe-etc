...
class fe2unit2_panel(fe2unit2_panelTemplate):
  ...
  def unit_drop_change(self, **event_args):
    ...
    if self.parent.combat.duels[1].unit.name == "Alm":
  ...
  def equip_drop_change(self, **event_args):
    """This method is called when an item is selected"""
    self.parent.combat.duels[1].setunitequip(self.equip_drop.selected_value)
  ...
  def supportbox_change(self, **event_args):
    ...
    self.parent.combat.duels[1].unit.support = self.supportbox.checked
